...
public class MAIN1 {
    ...
    public static void main(String[] args) {
        ...
        // 设置学习次数 为 72 TODO LS_NEURAL_NETWORK 训练次数将不需要 * 目标数量，速度要快一些
        lNeuralNetwork.setArg(LNeuralNetwork.LEARN_COUNT, SingletonCell.$(72));
        // 设置目标数值
        ...
        // TODO 确定模型可用，将模型保存
        ASModel.Utils.write(new File("C:\\Users\\Liming\\Desktop\\fsDownload\\MytModel1.as"), model);
    }
}