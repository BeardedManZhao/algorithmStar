...
public abstract class AlgorithmMagicException extends RuntimeException {
     ...
     * @since 1.4
     */
    public AlgorithmMagicException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public AlgorithmMagicException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public AlgorithmMagicException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
