...
public class FastRangeDoubleVector extends RangeVector<FastRangeDoubleVector, Double, double[], DoubleVector> {
    ...
    public DoubleVector shuffle(long seed) {
        return DoubleVector.parse(ASMath.shuffle(this.copyToNewArray(), seed, false));
    }
     ...
     */
    @Override
    public FastRangeDoubleVector add(Number value) {
        double v = value.doubleValue();
        return FastRangeDoubleVector.parse(this.getRangeStart() + v, this.getRangeEnd() + v);
    }
     ...
     */
    @Override
    public FastRangeDoubleVector diff(Number value) {
        double v = value.doubleValue();
        return FastRangeDoubleVector.parse(this.getRangeStart() - v, this.getRangeEnd() - v);
    }
}
