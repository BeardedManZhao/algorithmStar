...
public class DoubleRouteNet implements RouteNet<DoubleCoordinateMany, DoubleConsanguinityRoute> {
     ...
     */
    @Override
    public RouteNet<DoubleCoordinateMany, DoubleConsanguinityRoute> add(Number value) {
        throw NOT_SUP;
    }
     ...
     */
    @Override
    public RouteNet<DoubleCoordinateMany, DoubleConsanguinityRoute> diff(Number value) {
        throw NOT_SUP;
    }
