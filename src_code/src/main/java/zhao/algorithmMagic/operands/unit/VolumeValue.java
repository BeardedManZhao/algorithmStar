...
public class VolumeValue extends BaseValue {
    ...
    public VolumeValue(double valueNumber, Class<? extends BaseValue> c, KeyValue<Integer, String> baseNameKeyValue, BaseValueFactory baseValueFactoryClass) {
    ...
    protected static BaseValue parse(double valueNumber, KeyValue<Integer, String> baseNameKeyValue, BaseValueFactory baseValueFactoryClass) {
        return new BaseValue(valueNumber, VolumeValue.class, baseNameKeyValue, baseValueFactoryClass);
    }
}
