...
public interface NoSampleClassification {
     ...
     * Classification results.
     */
    HashMap<String, ArrayList<ColumnIntegerVector>> classification(String[] keys, ColumnIntegerMatrix columnIntegerMatrix);
     ...
     * Classification results.
     */
    HashMap<String, ArrayList<ColumnDoubleVector>> classification(String[] keys, ColumnDoubleMatrix columnDoubleMatrix);
}
