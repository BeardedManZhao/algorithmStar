...
public class WeightValue extends BaseValue {
    ...
    public WeightValue(double valueNumber, Class<? extends BaseValue> c, KeyValue<Integer, String> baseNameKeyValue, BaseValueFactory baseValueFactoryClass) {
    ...
    protected static BaseValue parse(double valueNumber, KeyValue<Integer, String> baseNameKeyValue, BaseValueFactory baseValueFactoryClass) {
        return new BaseValue(valueNumber, WeightValue.class, baseNameKeyValue, baseValueFactoryClass);
    }
}
