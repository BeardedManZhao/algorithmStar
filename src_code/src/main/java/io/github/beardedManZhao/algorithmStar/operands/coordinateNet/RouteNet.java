 ...
 *                         route type
 */
public interface RouteNet<CoordinateType extends Coordinate<?>, RouteType extends io.github.beardedManZhao.algorithmStar.operands.route.Route<RouteType, CoordinateType>>
